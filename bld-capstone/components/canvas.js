...
export default function Canvas() {
  ...
  const addBackground = () => {
    ...
    fabric.Image.fromURL(
      "https://firebasestorage.googleapis.com/v0/b/capstone-bld.appspot.com/o/moodboards%2FL9k9HFScp7VxkLlWk4bX%2FInitial%20Version%2F12fd829e-a1cc-4265-abb1-f0806bf4281f.jpg?alt=media&token=8b6b0067-1dc9-4591-a27e-4aff07e9ff2b",
      (image) => {
        editor.canvas.setDimensions({width: image.width, height: image.height});
